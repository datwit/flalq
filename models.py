...
from sqlalchemy import MetaData, Table, Column, String, Integer, SmallInteger,  DECIMAL, Date, BLOB, Text
...
employees = Table('employees', metadata, 
        Column('employeeNumber', Integer, primary_key=True),  # lo pone autoincrementado de forma automatica
        Column('lastName', String(50), nullable=False), 
        Column('firstName', String(50), nullable=False), 
        Column('extension', String(10), nullable=False), 
        Column('email', String(100), nullable=False, unique=True), 
        Column('officeCode', String(10), nullable=False), 
        Column('reportsTo', Integer),    #deberia incluirse una excepcion al Pdte para no dar error si con otro quedara empty
...
customers = Table('customers', metadata, 
        ...
        Column('creditLimit', DECIMAL(10,2))    #No muestra los decimales en la estructura de la tabla
)
...
orders = Table('orders', metadata, 
        ...
        Column('customerNumber', Integer, nullable=False)
)

orderdetails = Table('orderdetails', metadata, 
        Column('orderNumber', Integer, primary_key=True),
        Column('productCode', String(15), nullable=False, primary_key=True),
...
# print(repr(offices)) #imprime por consola el resultado de la tabla creada
